...
cmd_sources() {
  ...
  ui_kv "macOS kept free" "$(fmt_gb "$ASAHI_MIN_FREE_OS_BYTES")" "MIN_FREE_OS"
  ui_kv "Boot stub + EFI" "$(fmt_gb "$ASAHI_STUB_BYTES") + $(fmt_gb "$ASAHI_EFI_BYTES")" "STUB_SIZE, EFI template"
